...
var cnItems = {
    ...
    "Monsters": "怪物",
    "You": "你",
    "Continue with Google": "使用谷歌账号继续",
    "Create one": "创建账号",
    "Idle Qi Cultivator": "放置修仙",
    "No account?": "还没有账号？",
    "Progress saved locally — link an account anytime from your profile to sync across devices.": "进度已本地保存——可随时在个人中心绑定账号，实现多设备同步",
    "Sign In": "登录",
    "Sign in to save your progress across devices": "登录即可跨设备同步游戏进度",
    "Already have an account?": "已有账号？",
    "Create Account": "注册账号",
    "Sign in": "登录",
    "← Back to Sign In": "← 返回登录页面",
    "A confirmation link was sent to": "验证链接已发送至",
    "Check Your Email": "查看邮箱",
    "Click the link in the email to activate your account, then return here to sign in.": "点击邮件内链接激活账号，再回到此页面完成登录",
    ...
    "Gityx": "Gityx",
    "G8hh": "G8hh",
    '<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MCSRCFRX" \nheight="0" width="0" style="display:none;visibility:hidden"></iframe>': '<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MCSRCFRX" height="0" width="0" style="display:none;visibility:hidden"></iframe>',
    "": "",
    "": "",
    "": "",
    "": "",
