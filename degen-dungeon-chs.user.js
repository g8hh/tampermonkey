...
var cnItems = {
    ...
    "Travel to the Bloomtide Festival location from any map to start your spring adventure!": "从任意地图前往春日祭地点，开启你的春日冒险吧！",
    "Welcome to the": "欢迎来到",
    ...
    "Wait": "等待",
    "Pet Food": "宠物食物",
    "Above the Horizon Cover": "地平线上方的封面",
    ...
    "Lost Oasis Profile Cover": "失落的绿洲头像",
    "Luminyx Egg": "发光蛋",
    "Molten Depths Profile Cover": "熔火之渊头像",
    ...
    "You must complete or fail your current combat before starting a new one.": "在开始一场新的战斗之前，你必须完成或失败当前的战斗。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Inventory is full! \((.+) slots used\)$/, '库存已满！（已使用 $1 栏位）'],
    [/^Jan ([\d\.,]+), ([\d\.,]+)$/, '$2 年 1 月 $1'],
    [/^Feb ([\d\.,]+), ([\d\.,]+)$/, '$2 年 2 月 $1'],
    [/^Mar ([\d\.,]+), ([\d\.,]+)$/, '$2 年 3 月 $1'],
    [/^Apr ([\d\.,]+), ([\d\.,]+)$/, '$2 年 4 月 $1'],
