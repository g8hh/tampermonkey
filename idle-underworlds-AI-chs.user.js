...
"{{0}}d, {{1}}mn": "{{0}}天, {{1}}分钟",
    ...
    Object.assign(window.cnResourceNames, {
        "Some changes happened !": "发生了一些变化！",
        "add a \"first\" feature for new activities on the map": "新增地图活动\"首杀\"功能",
        "add relic or pass choice to rest nodes": "休息节点增加遗物或通关选项",
        "cost checker having lag": "成本检查器存在延迟",
        "display \"boss\" node on underworld leaderboard": "冥界排行榜显示\"Boss\"节点",
        "heritage stops automatic underworld sessions and villagers": "传承会停止自动冥界出征和村民",
        "improve tick speed": "优化tick速度",
        "minor guide updates": "小幅指南更新",
        "minor wording and changes": "小幅文本和改动",
        "other players can pay to get the location of new activites found by other people": "其他玩家可付费获取别人发现的新活动位置",
        "toggle to always destroy artefacts": "新增始终摧毁古神器的开关",
        "try optimize ram usage": "尝试优化内存使用",
        "NaN%": "NaN%",
        "Admin Pressure": "行政压力",
        "Ancient Legacy": "远古遗产",
        "Seal the Maw": "封印深渊之口",
        "Upgrade your town center to 5 to see this": "将城镇中心升至5级查看",
        " before this event starts to remove it and ": "在此事件开始前移除它，并",
        " boost instead !": "加成！",
        " for exemple": "例如",
        " with other players it will help.": "和其他玩家一起会有帮助。",
        " you could follow on the road I just did north of the maw": "你们可以沿着我刚在深渊之口北边修的路走",
        "(Forge)": "（锻造工坊）",
        "(Hunter Cabin)": "（猎人小屋）",
        "50K gold queued, hope it will go way faster": "5万金币已排队，希望能快很多",
        "• Empower the \"": "• 强化\"",
        "Current \"": "当前\"",
        "\" every 8-16 hours.": "\"每8-16小时",
        " for this building :": "适用于此建筑：",
        "\" hours.": "\"小时。",
        " of the hourly rate every ": "每小时速率的",
        ", to ": "，到",
        "12 sources": "12来源",
        "Abyssal Surge": "深渊涌流",
        "Abyssal Surges": "深渊涌流",
        "Abyssal Surge claimed: ": "已领取深渊涌流：",
        "\" every 10-20 hours.": "\"每10-20小时",
        "11 sources": "11来源",
        "Destroy\"": "摧毁\"",
        "\" Administrative Capacity": "\"行政容量",
        " • Gain ": " • 获得",
        "\" Locked, must be built in your domain": "\"已锁定，必须建在你的领地内",
        "(Mountain, Hill, Sand)": "（山脉、丘陵、沙地）",
        "(Plain, Hill)": "（平原、丘陵）",
        "(Plain, Sand)": "（平原、沙地）",
        "(Plain)": "（平原）",
        "(Plain, Fertile Plain, Hill)": "（平原、肥沃平原、丘陵）",
        "(Fertile Plain, Plain)": "（肥沃平原、平原）",
        "(Plain, Fertile Plain)": "（平原、肥沃平原）",
        "Void Shards : ": "虚空碎片：",
        " perfect": "完美",
        "@missingArrowPT": "@missingArrowPT",
        "Are the resources going to the maw already subtracted from the requirements? Or is it diminished once it reaches the maw?": "运往深渊之口的资源是已经从需求中扣除的？还是到达深渊之口后才扣除？",
        "Do forests impact the travel time?": "森林会影响运输时间吗？",
        "Feed the Abyssal Maw": "喂养深渊之口",
        "Forefather Mimi": "先祖 Mimí",
        "Generous Neuroclastys": "慷慨的 Neuroclastys",
        "I could do it right now, but im at work. So im gonna let work finish, grind out 1k extra purple crack fast, then do it  right after that": "我现在就可以做，但我在上班。所以等下班了，先快速刷1000个紫色裂隙，然后立马去做。",
        "I did the link in the sand": "我在沙地铺好了连接路",
        "I got a common mimi hehe, couldnt copy your result": "我拿到了普通 Mimi 嘿嘿，没能复制你的结果",
        "I moved my roads north of the maw... It's not a lot, but it's the best I can do at": "我把路挪到了深渊之口北边……不算多，但这是目前我能做到的最好",
        "I think the most worth it may be the road where we are forced to go through hard terrain": "我觉得最值得的可能是那条不得不穿过困难地形的路",
        "I trust and I put my ressources in a queue to maximise efficiency": "我相信，所以我把资源排队以最大化效率",
        "I underestimate the number of player,": "我低估了玩家数量，",
        "I'll try to farm VS to spam buffs after the Sandstor": "沙尘暴之后我会刷虚空碎片来疯狂放Buff",
        "I'll try to moove my roads, but it will but so many others": "我会尝试移动道路，但会影响很多其他人",
        "If mimi wasnt winning in the proto world id be bummed not to be first to heritage 2": "如果 Mimi 没有在原始世界赢，我会因为没第一个传承到2级而郁闷",
        "Light rain": "小雨",
        "Maw explosion": "深渊之口爆发",
        "Might be that i missed a weather?": "可能我漏掉了一个天气？",
        "Moved mine ✅": "我的已移走 ✅",
        "Not trying to blame anyone, but i don't see 15 persons commit. It's a bit late tho.": "不是想怪谁，但我没看到15个人在出力。不过有点晚了。",
        "Open-Handed Numenter": "慷慨的 Numenter",
        "Out of roads at": "道路用尽于",
        "Queued carts for 11h :D": "排队推车11小时 :D",
        "Rain": "雨",
        "Sandglass Serpent (1.8 kg)": "沙漏巨蛇（1.8 kg）",
        "Set a trap": "设置陷阱",
        "Summer": "夏季",
        "Trade Route Builder missingArrowPT": "贸易路线建造者 missingArrowPT",
        "World Nurturer Atemi": "世界滋养者 Atemi",
        "World Nurturer DerBastian": "世界滋养者 DerBastian",
        "actually the more efficient globally is to move everyones roads around the maws, since it will benifit every single players": "实际上从全局来说更高效的做法是把所有人的路都绕到深渊之口周围，因为这对每个玩家都有利",
        "and road x4": "道路×4",
        "and the maw would be filled instantly ^^\"": "深渊之口瞬间就能填满 ^^\"",
        "boosts are up for the usefull ressources": "有用资源的加成已就绪",
        "contrary to the road around our own town that only help 1 player to go faster": "相比于只让1个玩家加速的、绕自己城镇的路",
        "gain a production": "获得产量",
        "i gained 10 minutes on the updated timer of my carts": "我的推车计时器更新后，我赚了10分钟",
        "if everyone sent 20 carts twice:": "如果每人发两次20辆推车：",
        "if we can go up to ": "如果我们能到达",
        "it sucks a little that the requirement is so high with so few active players": "活跃玩家这么少需求还这么高，有点难受",
        "it's 9.360.000 ressources": "需要9,360,000资源",
        "now it's just about having enough chariots and fast enough,": "现在就看谁有足够多的战车而且够快，",
        "plain and fertile plain are the best terrain": "平原和肥沃平原是最佳地形",
        "road on plains are usually better than anything else": "修在平原上的路通常比其他任何地方都好",
        "so much ressources in queue for the maw...i have a market transaction that will be delivered in 10 hours or something like that": "排队给深渊之口的资源太多了……我有一笔市场交易大约10小时后送达",
        "so ressourceswise, wiff buffs now, and tomorrow after the sandstor": "所以从资源角度看，现在放Buff，明天沙尘暴后再放",
        "the ressource going is substracted": "运送中的资源是会扣除的",
        "there is a path with less forests and deserts": "有一条森林和沙漠较少的路",
        "travel time is indeed a big limiting factor": "运输时间确实是个很大的限制因素",
        "we can get enough ressources": "我们能凑够资源",
        "we could optimize road by going north east of the maw": "我们可以往深渊之口东北方向走以优化路线",
        "will speed up a lot of carts that come from north": "会大大加速从北方来的推车",
        "with market level 4 and the ability to queues them it goes really fast": "市场4级加上排队功能，真的超快",
        "Oooooh. I can heritage now... But alas.. I should wait until the maw is done so I can help with more deliveries. lol": "哦哦哦。我现在可以传承了……不过唉，我应该等深渊之口完成后再传承，这样才能帮忙送更多货。哈哈",
        " o7": " o7",
        "@Aiyaret": "@Aiyaret",
        "Thanks for your effort ": "感谢你的付出",
        "@Mimi": "@Mimi",
        "Nice find ": "发现得好",
        "No problem! lol": "没问题！哈哈",
        "I don't know about anyone else, but I don't want that penalty. lol": "不知道别人怎么想，反正我不想要那个惩罚。哈哈",
        "I don't understand how Auto Sessions works. I left it for around 1h and nothing happened. Got no shards. Is it like a cooldiwn and at the end of it you get all the rewards ?": "我不懂自动出征怎么运作。我等了大约1小时什么都没发生，没拿到碎片。是不是类似冷却时间，结束的时候一次性拿所有奖励？",
        "Yeah that could be a real problem to progress and build those monuments": "是啊，那可能真的是推进和建造那些纪念碑的大问题",
        "Yeaaa, and I can't answer your question. I don't think i've unlocked auto sessions yet.": "是啊，我也回答不了你的问题。我觉得我还没解锁自动出征呢。",
        "Protean Mikael": "千变万化的 Mikael",
        "You should see the timer under auto session tab": "你应该能在自动出征标签页下看到计时器",
        "They last 4h, and run offline": "持续4小时，离线也能运行",
        "So 6/day": "所以每天6次",
        "food and gold should be completed today or tomorrow,": "食物和金币应该今天或明天完成，",
        "equipement is the last tricky parts to complete the maw": "装备是完成深渊之口的最后难关",
        "perfect to far": "完美胜任",
        "AC 1": "AC 1",
        "LVL 3": "LVL 3",
        "LVL 2": "LVL 2",
        ...
        "Build road": "修建道路",
        "Destroy road": "拆除道路",
        "Claim 100% Abyssal Surge": "领取100%深渊涌流",
        "Claim 50% Abyssal Surge": "领取50%深渊涌流",
        "Current expertise level of this building": "该建筑当前专精等级",
        "Ore Supply Chain": "矿石供应链",
        "Through Hills and Valleys": "穿山越谷",
        "Agricultural Networ": "农业网络",
        "Open Pastures": "开阔牧场",
        "Harbor Cluster": "港口群集",
        "Tidal Grounds": "潮汐之地",
        "Abyssal Armada": "深渊舰队",
        ...
        "Active season": "活跃季节",
        "Soil Fertility": "土壤肥沃",
        "Forester's Pact": "护林人契约",
        "Woodland Mastery": "林地精通",
        "Trapper's Alliance": "捕兽者联盟",
        "Hunter Cabin": "猎人小屋",
        "Gain +100% production when there is no adjacent building": "无相邻建筑时产量+100%",
        "Gain +15% production for each adjacent hills tile": "每个相邻丘陵格子产量+15%",
        "Gain +25% production for each adjacent mine": "每个相邻矿井产量+25%",
        "Roads make cart travel ×4 faster.": "道路使推车速度×4。",
        "Gain +15% production for each adjacent plain tile": "每个相邻平原格子产量+15%",
        "Gain +25% production for each adjacent far": "每个相邻农场产量+25%",
        "Gain +15% production for each adjacent shallow water tile": "每个相邻浅水格子产量+15%",
        "Gain +25% production for each adjacent fishing port": "每个相邻渔港产量+25%",
        "Gain +15% production for each adjacent deep water tile": "每个相邻深水格子产量+15%",
        "Gain +25% production for each adjacent abyssal barge": "每个相邻深渊驳船产量+25%",
        "Gain +15% production for each adjacent fertile plain tile": "每个相邻肥沃平原格子产量+15%",
        "Gain +15% production for each adjacent forest tile": "每个相邻森林格子产量+15%",
        "Gain +25% production for each adjacent hunter cabin": "每个相邻猎人小屋产量+25%",
        "Gain +25% production for each adjacent lumber camp": "每个相邻伐木场产量+25%",
        "📍 Plain (393,50)": "📍 平原 (393,50)",
        "📍 Plain (392,50)": "📍 平原 (392,50)",
        "📍 Plain (391,51)": "📍 平原 (391,51)",
        "📍 Plain (392,49)": "📍 平原 (392,49)",
        "📍 Plain (394,50)": "📍 平原 (394,50)",
        "📍 Plain (395,50)": "📍 平原 (395,50)",
        "📍 Plain (396,51)": "📍 平原 (396,51)",
        "📍 Shallow Water (392,46)": "📍 浅水 (392,46)",
        "📍 Shallow Water (393,46)": "📍 浅水 (393,46)",
        "📍 Shallow Water (394,46)": "📍 浅水 (394,46)",
        "📍 Shallow Water (396,46)": "📍 浅水 (396,46)",
        "📍 Shallow Water (395,46)": "📍 浅水 (395,46)",
        "📍 Forest (388,54)": "📍 森林 (388,54)",
        "📍 Forest (387,54)": "📍 森林 (387,54)",
        "📍 Forest (386,53)": "📍 森林 (386,53)",
        "📍 Fertile Plain (396,52)": "📍 肥沃平原 (396,52)",
        "📍 Fertile Plain (387,53)": "📍 肥沃平原 (387,53)",
        "📍 Fertile Plain (388,53)": "📍 肥沃平原 (388,53)",
        "📍 Deep Water (395,45)": "📍 深水 (395,45)",
        "📍 Sand (395,47)": "📍 沙地 (395,47)",
        "📍 Sand (394,47)": "📍 沙地 (394,47)",
        "You cannot build a road here. Terrain type is not valid, or you reached your limit.": "这里不能修路。地形类型无效，或已达到上限。",
        "You cannot add new tiles to your domain, limit reached or the tile is not connected to your domain.": "无法向领地添加新格子，已达上限或该格子未连接到你的领地。",
        "This tile is too far from your Town Center. You can only claim tiles within 8 hexes.": "这个格子离城镇中心太远。你只能在8格范围内占领。",
        "Releasing this would leave orphan tiles, all your tiles must be connected to your Town Center.": "释放这将产生孤立的格子，你的所有格子必须与城镇中心相连。",
        "Free territory": "自由领土",
        "Artefact found!": "发现古神器！",
        "title unlocked": "头衔已解锁",
        "Title unlocked": "头衔已解锁",
        "new artefact!": "新古神器！",
        "Cracked Lens": "破损透镜",
        "Enemy units have their range reduced to 1.": "敌方单位射程减为1。",
        "Golden Amulet": "黄金护符",
        "If the session is won, generates 5k gold as extra reward.": "出征胜利后，生成5000金币作为额外奖励。",
        "Void Crystal of Fate": "虚空命运水晶",
        "Improve Void Shards earned by +50%.": "虚空碎片获取量+50%。",
        "+ On session victory, generates an extra Chest on the surface.": "+ 出征胜利时，在地面生成一个额外宝箱。",
        "A grand monument erected in honor of your civilization's glory. Its mere presence inspires workers across your domain, pushing them beyond their natural limits.": "为颂扬你文明的荣耀而树立的宏伟纪念碑。仅其存在就能激励整个领地的工人，超越他们的自然极限。",
        "This planet already has 2 monuments in progress, please wait for one to be completed.": "本星球已有2座纪念碑在建，请等待其中一座完工。",
        "Produces food. Food is key for survival. (requires Fertile Plain)": "生产食物。食物是生存的关键。（需要肥沃平原）",
        "Produces food. Food is key for survival. (requires Shallow Water next to any Land)": "生产食物。食物是生存的关键。（需要紧邻任意陆地的浅水）",
        "A hulking vessel anchored over the seafloor for deep-water mining. Requires a Fishing Port to operate. Harvests stone and iron in shallow waters, stone and gold in deep waters. Consumes food and wood.": "锚定在海底的巨型采矿船。需要渔港才能运作。在浅水采集石头和铁，在深水采集石头和黄金。消耗食物和木材。",
        "Manage your Army Templates from this building to explore the Underworld with the army of your choice.": "从该建筑管理你的军队模板，用你选择的军队探索冥界。",
        "Autonomous Archers": "自主弓手",
        "Battle Cleric": "战斗牧师",
        "Church": "教堂",
        "Frontline Focus": "前线专注",
        "Go to Underworld": "前往冥界",
        "The building on this tile must be in your domain, you cannot release the tile.": "此格子上的建筑必须在你的领地中，你无法释放该格子。",
        "This building unlocks a new premade unit template for your Underworld Sessions. You don't produce units directly, they are recruited on the fly when starting a new Session.": "该建筑为你的冥界出征解锁新的预设单位模板。你无需直接生产单位，队伍将在开启新出征时当场招募。",
        "Your building is already upgraded to the maximum.": "你的建筑已达到最高等级。",
        "×0.9 power for all your units.": "所有单位×0.9战力。",
        "Transform Plain into Fertile Plain": "将平原改造为肥沃平原",
        "Transform Plain into Hill": "将平原改造为丘陵",
        "Transform Plain into Sand": "将平原改造为沙地",
        "Transform Sand into Plain": "将沙地改造为平原",
        "Activity Finder": "活动查找器",
        "All activities": "所有活动",
        "But more spots are available on the map for you to find!": "但地图上还有更多地点等你发现！",
        "Find resource terrain tiles sorted by distance from your Town Center.": "查找按距城镇中心排序的资源地形格子。",
        "Free tiles only": "仅空闲格子",
        "No pending activity location hints to buy right now.": "当前没有待购买的活动位置提示。",
        "Hint prices drop the more of them you have available at once.": "同时可用的提示越多，单价越低。",
        "Terrain Finder": "地形查找器",
        "Gold Deposit": "金矿脉",
        "Iron Deposit": "铁矿脉",
        "Stone Deposit": "石矿脉",
        "Collectible Rewards": "收集奖励",
        "Granary District": "粮仓区",
        "Lumber District": "木材区",
        "Mason District": "石工区",
        "Strategic Center, Alchemist Hut and Statue": "战略中心、炼金小屋和雕像",
        "Reset my empire": "重置我的帝国",
        "\"You cannot add new tiles to your domain, limit reached or the tile is not connected to your domain.\\\"\"": "无法向领地添加新格子，已达上限或该格子未连接到你的领地。\"",
        "\"Roads make cart travel ×4 faster.\\\"\"": "道路使推车速度×4。\"",
        "\"This tile is too far from your Town Center. You can only claim tiles within 8 hexes.\\\"\"": "这个格子离城镇中心太远。你只能在8格范围内占领。\"",
        "\"Releasing this would leave orphan tiles, all your tiles must be connected to your Town Center.\\\"\"": "释放这将产生孤立的格子，你的所有格子必须与城镇中心相连。\"",
        ...
        " carts\n                ": " 推车\n                ",
        " of the hourly rate to collect every 12-36 hours.\n                ": " 的小时产量，每12~36小时收集一次。\n                ",
        " Cavalry": " 骑兵",
        " of missing troops": " 的失踪部队",
        " power by ": " 战力乘以",
        " to other players": " 给其他玩家",
        "(Default": "(默认",
        "Recover ": "恢复 ",
        "Action Type": "动作类型",
        "Active relics": "已激活古神器",
        "Available carts": "可用推车",
        "Corridor Vision": "走廊视野",
        "Do not do anything": "不执行任何操作",
        "Fight node": "战斗节点",
        "Life": "生命",
        "Magic shield": "魔法护盾",
        "Market Status": "市场状态",
        "Melee attac": "近战攻击",
        "Movement per turn": "每回合移动力",
        "No active carts": "无活跃推车",
        "Open Market": "开放市场",
        "Power": "战力",
        "Race Day": "竞赛日",
        "Radius based": "基于半径",
        ...
        "You are here": "你在这里",
        "send presents": "发送礼物",
        "-0.5% duration per tile per exp. level (below lvl. 50).": "每经验等级每个格子减少0.5%持续时间（50级以下）。",
        "Earn 6.67 base expertise per 100 tile when validating a travel.": "出征结算时每100个领地格子获得6.67基础专精度。",
        "Heritage right after the week change is usually nice to get next to maw or to reorganise production": "周换季之后马上进行传承通常不错，可以放到深渊之口旁边或重新布局生产。",
        "Hit front and back.": "攻击前后排。",
        "I definitely need to reorganize my production once I do heritage. lol": "传承之后我一定要重新整理生产布局。哈哈",
        "Pausing this building will prevent new sales on the market and receiving presents.": "暂停此建筑将阻止市场上的新销售和接收礼物。",
        "The Underworld — Combat Basics": "冥界——战斗基础",
        "Architect Flodess": "建筑师 Flodess",
        "Four-Leaf Pioneer Elquin": "四叶开拓者 Elquin",
        "Heavy Cavalry": "重骑兵",
        "Hungry Slufu": "饥饿的 Slufu",
        "Relic Hunter DerBastian": "古神器猎人 DerBastian",
        "World Nurturer sambucco": "世界培育者 sambucco",
        "fantonico, Embraced by Chaos": "fantonico，混沌之拥",
        "cavalry": "骑兵",
        "swordsmen": "剑士",
        "Swordsman Relic": "剑士遗物",
        "📍 Plain (391,49)": "📍 平原 (391,49)",
        "📍 Plain (392,48)": "📍 平原 (392,48)",
        "📍 Plain (394,48)": "📍 平原 (394,48)",
        "D2": "D2",
        "Freds": "Freds",
        "MonyClair": "MonyClair",
        "Rawno": "Rawno",
        ...
        "T0": "T0",
        "lostRD": "lostRD",
    });    window.cnResourceNames["总持续时长：28d"] = "总持续时长：28天";
