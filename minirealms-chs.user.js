...
var cnItems = {
    ...
    "Plant crops": "种植作物",
    "Plowing the land...": "耕地...",
    "Resources generated from your lands are stored in your realm which has a max capacity. Warehouses are used to expand this capacity and now that you have more capacity, why not increase resource production with some crops.": "从你的土地上产生的资源存储在你的领域有一个最大的容量。仓库是用来扩大这种能力的，现在你有更多的能力，为什么不增加一些作物的资源生产。",
...
var cnRegReplace = new Map([
    ...
    [/^Attack ([\d\.,]+) land in another realm$/, '攻击 土地 $1 在另一个王国'],
