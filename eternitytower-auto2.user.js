...
// @grant        none
// @require      https://g8hh.com.cn/static/js/keepalive.js
...
! function () {
    ...
    content += '<option value="polished_orichalcum">抛光的星陨石-单个2200金币</option>';
    content += '<option value="polished_fairy_steel">抛光的仙女钢-单个3000金币</option>';
