// ==UserScript==
// @name         Mafia MMO 简中汉化脚本
// @namespace    https://www.g8hh.com.cn/
// @version      0.0.1
// @description  网页游戏 Mafia MMO (https://mafiammo.com/) 的简体中文汉化脚本。Simplified Chinese i18n script for web game Mafia MMO.
// @author       好阳光的小锅巴 & 麦子
// @copyright    锅巴汉化
// @contributionUR    https://gityx.com/donate/intro.html
// @icon         https://www.zed.city/icons/favicon.svg
// @license      MIT
// @include      *https://mafiammo.com/*
// @grant        none
...
var cnItems = {
    ...
    "Create Account": "创建账户",
    "Create your account to enter the underworld": "创建您的帐户，进入地下世界",
    "Email": "电子邮件",
    "Female": "女",
    "Gender": "性别",
    "Join the Family": "加入家庭",
    "Login Here": "在这里登录",
    "Mafia MMO": "黑手党MMO",
    "Male": "男",
    "Min 6 characters": "最少6个字符",
    "Password": "密码",
    "Passwords don't match": "密码不匹配",
    "Passwords match": "密码匹配",
    "Promo Code (Optional)": "促销码（可选）",
    "Select Gender": "选择性别",
    "Strong": "强",
    "Username": "用户名",
    "Account created successfully! You can now login with username:": "帐户创建成功！您现在可以使用用户名登录：",
    "Create your account to enter the underworld": "创建您的帐户，进入地下世界",
    "Go to Login": "进入登录",
    "Join the Family": "加入家庭",
    "Username already taken. Please choose another.": "用户名已被占用。请另选一个。",
    "OR": "或",
    "Rule the neon underworld as a rising hustler. Recruit your crew, build a criminal empire, outsmart rivals, and fight your way to the top. Every decision could make — or break — your legacy.": "作为一名冉冉升起的骗子，统治霓虹灯的地下世界。招募你的手下，建立一个犯罪帝国，智胜对手，一路打到顶峰。每一个决定都可能成就或毁掉你的遗产。",
    "About Us": "关于我们",
    "Accept All": "全部接受",
    "Contact": "联系",
    ...
    "Enter the Mafia Den - Text Based RPG": "进入黑手党基于文本的RPG游戏",
    "Learn more": "了解更多",
    "Login": "登录",
    "MAFIA MMO": "黑手党MMO",
    "Online Now": "现在在线",
    ...
    "We use cookies to enhance your experience, analyze site traffic, and for security purposes. \n                    By clicking \"Accept\", you consent to our use of cookies. ": "我们使用cookie来增强您的体验、分析站点流量以及出于安全目的。点击“接受”即表示您同意我们使用cookies。",
    "Bank": "银行",
    "Become a VIP": "成为VIP",
    "Business": "商业",
    "Cash": "现金",
    ...
    "Train": "训练",
    "Tutorial": "教程",
    "Welcome to the Family": "欢迎加入这个大家庭",
    "Welcome to the underworld, soldier. I'm your mentor, and I'll be showing you the ropes. In this world, respect is earned through power, cunning, and loyalty.": "欢迎来到地下世界，士兵。我是你的导师，我会教你怎么做。在这个世界上，尊重是通过力量、狡猾和忠诚来获得的。",
    "Work": "工作",
    "XP": "经验",
    "Your Gang": "你的帮派",
    "affects your training gains.": "影响你的训练收益。",
    "Brave": "勇气",
    "Energy": "能量",
    "Energy & Will": "能量与意志",
    "is used for crimes. All resources regenerate over time.": "用于犯罪。所有资源都会随着时间恢复。",
    "is used for training at the gym and working.": "用于健身房训练和工作。",
    "Next": "下一个",
    "Previous": "上一页",
    "Will": "将",
    "You can refill energy & will with crystals!": "你可以用水晶补充能量和意志！",
    "Agility": "敏捷",
    "Guard": "守卫",
    "helps you in fights and attacks,": "在战斗和攻击中帮助你，",
    "helps you work jobs and earn money.": "帮助你工作和赚钱。",
    "Labour": "劳动",
    "makes you faster in combat,": "让你在战斗中更快，",
    "protects you from damage, and": "保护你免受伤害，并且",
    "Strength": "力量",
    "Train at the gym to increase your stats!": "在健身房训练，提高你的属性！",
    "Your Stats": "你的属性",
    ", or starting businesses. Visit the": "，或者创业。访问",
    "Bank your money to prevent losses when attacked!": "把你的钱存入银行，以防受到攻击时损失！",
    "Committing Crimes": "犯罪",
    "Earn cash by": "赚取现金通过",
    "Fighting in the Battle Tent": "在战斗帐篷中战斗",
    "Making Money": "赚钱",
    "to keep your money safe from thieves!": "为了保护你的钱不被小偷偷走！",
    "Working Jobs": "工作内容",
    "": "",
    "": "",
    "": "",
    ...
    "*": "*",
    "© 2025 SaMz. All Rights Reserved.": "© 2025 SaMz. All Rights Reserved.",
    "© 2025 Mafia MMO. All Rights Reserved.": "© 2025 Mafia MMO. All Rights Reserved.",
    "": "",
    "": "",
    "": "",
    "%": "%",
